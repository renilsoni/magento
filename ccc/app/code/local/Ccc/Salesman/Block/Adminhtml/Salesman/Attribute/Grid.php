 ...
 * 
 */
class Ccc_Salesman_Block_Adminhtml_Salesman_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
	protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('salesman/salesman_attribute_collection');
